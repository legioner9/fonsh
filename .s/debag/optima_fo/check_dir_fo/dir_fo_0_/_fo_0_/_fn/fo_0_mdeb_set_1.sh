#!/bin/bash
#. "$HOME/.bashrc"
filename="${FONSH_PATH}/.s/debag/optima_fo/check_dir_fo/dir_fo_0_/_fo_0_/_fn/fo_0_mdeb_set_1.sh"
...
local d_name=$(dirname ${FONSH_PATH}/.s/debag/optima_fo/check_dir_fo/dir_fo_0_/_fo_0_/_fn/fo_0_mdeb_set_1.sh)
