...
filename="${FONSH_PATH}/.s/debag/optima_fo/check_dir_fo/dir_fo_0_/fo_0_.sh"
...
local FN_DIR=${FONSH_PATH}/.s/debag/optima_fo/check_dir_fo #? contane dir of function
local FLN=$0
local ARGS=($@)
local NARGS=$#
local ARGS1=$1
...
#{see_cntl}
exit_err_fo_0_() { #* $1 error message
local arg1="$1"
unset_autoargs_fo_0_
...
# >${FN_OUT_DIR}/com_fo_0_.res
# COMMAND &>>${FN_OUT_DIR}/com_fo_0_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_fo_0_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_fo_0_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_fo_0_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
