#!/bin/bash
#. "${HOME}/.bashrc"
filename="${FONSH_PATH}/actio/mall/dir_gfg_f_/.d.ax/.mdeb/a1_fp_f_mdeb_zx.sh"
...
local d_name=$(dirname ${FONSH_PATH}/actio/mall/dir_gfg_f_/.d.ax/.mdeb/a1_fp_f_mdeb_zx.sh)
