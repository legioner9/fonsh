#!/bin/bash
#. "${HOME}/.bashrc"
filename="${FONSH_PATH}/actio/mall/dir_gfg_f_/.d.ax/.mdeb/.cntl/gfg_f_mdeb.sh"
...
local d_name=$(dirname ${FONSH_PATH}/actio/mall/dir_gfg_f_/.d.ax/.mdeb/.cntl/gfg_f_mdeb.sh)
