...
cd ${HOME}/.st.rc.d/.st.tst.d/_zip_to.tst.d || echo "cd ${HOME}/.st.rc.d/.st.tst.d/_zip_to.tst.d EXEC_FALI" >&2

# if true; then
#     echo "_zip_to"
# fi

: >${HOME}/.st.rc.d/.st.tst.d/_zip_to.tst.d/res
...
if [ 0 -eq "$flag" ]; then
    echo "in file://${HOME}/.st.rc.d/.st.tst.d/_zip_to.tst.d/_zip_to.tst.sh fail" >&2
    diff res pre >&2
    return 1
else
    echo "in file://${HOME}/.st.rc.d/.st.tst.d/_zip_to.tst.d/_zip_to.tst.sh true"
    return 0
fi
