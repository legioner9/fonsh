...
filename="${FONSH_PATH}/actio/dir_fo_fff_/fo_fff_.sh"
...
#{see_cntl}
exit_err_fo_fff_() { #* $1 error message
local arg1="$1"
unset_autoargs_fo_fff_
...
# >${FN_OUT_DIR}/com_fo_fff_.res
# COMMAND &>>${FN_OUT_DIR}/com_fo_fff_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_fo_fff_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_fo_fff_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_fo_fff_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
